...
//import static cofh.lib.util.references.CoreReferences.FLUID_FILTER_CONTAINER;
//
...
//
//    public FluidFilterContainer(int windowId, PlayerInventory inventory, PlayerEntity player) {
//
