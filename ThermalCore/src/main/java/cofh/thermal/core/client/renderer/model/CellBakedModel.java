...
public class CellBakedModel extends BakedModelWrapper<IBakedModel> implements IDynamicBakedModel {
    ...
    // region HELPERS
    protected TextureAtlasSprite getTextureRaw(byte side) {
    ...
    protected byte[] getSideConfigRaw(CompoundNBT tag) {
    ...
    protected ItemOverrideList overrideList = new ItemOverrideList() {
